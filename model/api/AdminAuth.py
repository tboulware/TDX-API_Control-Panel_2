...
class AdminAuth(object):
    ...
    def __init__(self):
        ...
        self.__API_URL_ROOT_SB = "https://service.uoregon.edu/SBTDWebApi/api"
    ...
    def getURLRoot(self):
        if  self.__useSandBox:
            return self.__API_URL_ROOT_SB
        else:
            return self.__API_URL_ROOT

    def setUseSandbox(self, value):
        self.__useSandBox = value
